...
l0=gb.not.unknown %>%dplyr::count(CoV_genus) 

l1=gb.not.unknown %>% dplyr::count(CoV_genus, subgenus) 

l2=gb.not.unknown %>% dplyr::count(CoV_genus, subgenus, class) 

l3=gb.not.unknown %>% dplyr::count(CoV_genus, subgenus, class, order)

l4=gb.not.unknown %>% dplyr::count(CoV_genus, subgenus, class, order, family) 
